...
const voordelen = [
  {
    ...
    text: 'Bedrijven op positie 4 of lager krijgen minder dan 5% van de kliks. In de Top 3 staan betekent dat het grootse deel van de zoekers jou ziet.',
    icon: (
  ...
  },
  {
    ...
    text: 'Wie in de Top 3 van Google Maps staat, wordt direct gebeld of aangevraagd via de bedrijfsvermelding.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden className="ranking-voordelen__icon">
  ...
  },
  {
    ...
    text: 'Een Top 3-notering met sterke reviews werkt als sociaal bewijs en verlaagt de drempel om contact op te nemen.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden className="ranking-voordelen__icon">
  ...
  },
  {
    ...
    text: 'Je ontvangt wekelijks een heatmap die per zoekwoord en locatie laat zien op welke positie je staat.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden className="ranking-voordelen__icon">
...
export function RankingVoordelen() {
  return (
    <FadeUpSection className="bg-section-2" aria-labelledby="ranking-voordelen-title">
      <Container>
