...
const callBullets = [
  ...
  'Bespreking van je Ads-mogelijkheden',
]
    ...
    >
      <Container>
        <div className="contact-options__header">
          <h2 id="ads-cta-title" className="heading-section">
            Klaar om direct bovenaan te staan?
          </h2>
          <p className="contact-options__lead text-section-lead">
            Ontdek je mogelijkheden of bespreek direct je Ads-strategie met ons.
          </p>
        </div>
