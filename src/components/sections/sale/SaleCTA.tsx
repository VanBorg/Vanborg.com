...
const callBullets = [
  ...
  'Bespreking van de bundelaanbieding',
]
    ...
    >
      <Container>
        <div className="contact-options__header">
          <h2 id="sale-cta-title" className="heading-section">
            Profiteer van de bundel
          </h2>
          <p className="contact-options__lead text-section-lead">
            Ontdek je huidige positie of bespreek direct de bundelaanbieding met ons.
          </p>
        </div>
